...
//	}
//
//	x := "mongodb://localhost:27017,localhost:27018"
//	// Set up MongoDB client options
//	opts := options.Client().SetMaxPoolSize(1).ApplyURI(x).SetMonitor(monitor)
//
...
//	defer cancel()
//
//	db.Collection("testcoll").InsertOne(ctx, bson.D{{"x", 1}})
//
